          ...
          <div class="container-fluid">
              <div class="card mb-3">
                  ...
                  <div class="card-body">
                      ...
                      <!--Search-->
                    <div>
                      <form id="formFiltros" action="ajax/listarcuentas?modo=tabla" class="form-inline mb-3" onsubmit="buscar();">
                        ...
                        <button type="button" class="btn btn-success btn-sm" onclick="nuevo();">Nueva Cuenta</button>
                </form>
                    </div>
            <!--End Search-->

                <!-- Modal Carreras -->
                <div class="modal fade bd-example-modal-sm" id="modalCuentas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title w-100">Registro de Cuentas</h5>
                        ...
                        <div class="modal-body mx-2">
                            ...
                            <form id="formMantenimiento" action="mantenimiento/cuentas" onsubmit="validar();return false;">
                                {{ csrf_field() }}
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="numero" id="txtNumero" placeholder="Numero">
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script>
    ...
    function validar(){
        ...
        if($("#txtNumero").val().toString().trim().length==0){
            mensajeToast("ERROR","NO HAS LLENADO EL CAMPO NUMERO");
            return false;
        }
