          ...
          <div class="container-fluid">
              <div class="card mb-3">
                  ...
                  <div class="card-body">
                      ...
                      <!--Search-->
                    <div>
                      <form id="formFiltros" action="ajax/listarproyectos?modo=tabla" class="form-inline mb-3" onsubmit="buscar();">
                   ...
                   <input class="form-control mr-sm-2 text-size-xm" name="nombre" type="search" placeholder="Buscar..." aria-label="Search">
                        ...
                        <button type="button" class="btn btn-success btn-sm" onclick="nuevo();">Nuevo Proyecto</button>
                </form>
                    </div>
            <!--End Search-->

                <!-- Modal TipoUsuario -->
                <div class="modal fade bd-example-modal-sm" id="modalProyectos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title w-100">Registro de Proyectos</h5>
                        ...
                        <div class="modal-body mx-2">
                            ...
                            <form id="formMantenimiento" action="mantenimiento/proyectos" onsubmit="validar();return false;">
                                {{ csrf_field() }}
                                <input type="hidden" name="id_usuario" value="{{$id_usuario}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <select class="custom-select" name="tipo" id="slcTipo">
...
<script>
    ...
    function nuevo(){
        ...
        $("#txtNombre").val("");
        $("#inptModo").val("N");
        $("#modalProyectos").modal();
    }
    
    function editar(id){
        $.ajax({
            type: 'GET',
            url: "ajax/listarproyectos",
            data: "id="+id,
