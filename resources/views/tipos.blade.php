    ...
    <div class="container-fluid">
        <div class="card mb-3">
            ...
            <div class="card-body">
                <!--Search-->
                <div>
                    <form id="formFiltros" action="ajax/listartiposusuario?modo=tabla" class="form-inline mb-3" onsubmit="buscar();">
                        ...
                        <button type="button" class="btn btn-success btn-sm" onclick="nuevo();">Nuevo Tipo</button>
                    </form>
                </div>
                <!--End Search-->

                <!-- Modal TipoUsuario -->
                <div class="modal fade bd-example-modal-sm" id="modalTipoUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title w-100">Registro de Tipo Usuario</h5>
                        ...
                        <div class="modal-body mx-2">
                            ...
                            <form id="formMantenimiento" action="mantenimiento/tipos" onsubmit="validar();return false;">
                                {{ csrf_field() }}
